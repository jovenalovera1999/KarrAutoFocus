  ...
  const navItems: NavItem[] = [
    ...
    // },
    {
      ...
      subItems: [
        ...
        { name: "All Units", path: "/car/unit/all" },
        { name: "Available Units", path: "/car/unit/available" },
        { name: "Reserved Units", path: "/car/unit/reserved" },
        { name: "Sold Units", path: "/car/unit/sold" },
      ],
    },
    {
    ...
    <ul className="flex flex-col gap-4">
      {navItems.map((nav, index) => {
        if (
          ...
          nav.path?.toLowerCase() === "/manage/users"
        )
          return null;
          ...
          <li key={nav.name}>
            {nav.subItems ? (
              <button
                ...
                className={`menu-item group h-10 cursor-pointer ${
                ...
                <ul className="mt-2 space-y-1 ml-9">
                  {nav.subItems.map((subItem) => (
                    <li key={subItem.name}>
                      <Link
                        href={subItem.path}
                        className={`menu-dropdown-item h-10 cursor-pointer ${
